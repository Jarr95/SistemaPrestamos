			...
			<div class="full-box nav-lateral-content">
				<figure class="full-box nav-lateral-avatar">
					...
					<figcaption class="roboto-medium text-center">
						<?php echo $_SESSION['nombre_sp']." ".$_SESSION['apellido_sp']; ?><br><small class="roboto-condensed-light"><?php echo $_SESSION['usuario_sp']; ?></small>
					</figcaption>
				</figure>
				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						...
						<?php if($_SESSION['privilegio_sp']==1){?>
						<li>
							...
							<ul>
								...
								<li>
									<a href="u<?php echo SERVERURL; ?>ser-search/"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar usuario</a>
								</li>
							</ul>
						</li>
						<?php } ?>
