<?php
if ($login->encryption($_SESSION['id_sp']) != $pagina[1]) {
...
<div class="container-fluid">
	...
	?>
		<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="update" autocomplete="off">
			...
			<fieldset>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-12">
							<div class="form-group">
								<span>Estado de la cuenta &nbsp; <?php if ($campos['usuario_estado'] == "Habilitada") {
			...
			<?php if($login->encryption($_SESSION['id_sp']) != $pagina[1]){?>
